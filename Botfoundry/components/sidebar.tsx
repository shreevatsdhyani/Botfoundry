...
import { Bot, ChevronLeft, ChevronRight, Crown, LayoutDashboard, LogOut, Plus, User, Zap } from "lucide-react"
import Link from "next/link"
import { usePathname } from "next/navigation"
import { useState } from "react"

function QuickStats() {
  const { activeBots, newThisMonth } = useChatbots()

  return (
    <>
      <div className="flex justify-between text-sm">
        <span className="text-muted-foreground">Active Bots</span>
        <span className="font-semibold text-foreground">{activeBots}</span>
      </div>
      <div className="flex justify-between text-sm">
