...
export default function CreateChatbot() {
  ...
  const handleCreateChatbot = async () => {
    ...
    try {
      const realFiles = successfulFiles.map((f) => f.file!)
      const res = await BotFoundryAPI.createChatbot(
        businessName,
      ...
      const newChatbot = {
        ...
        name: businessName,
        description: "AI chatbot trained on your business data",
